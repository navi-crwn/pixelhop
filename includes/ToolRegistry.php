        ...
        public static function all(): array
        {
            return [
                ...
                'upscale' => [
                    ...
                    'name' => 'AI HD Upscale',
                    'icon' => 'zoom-in',
                    'description' => 'Upscale low-resolution images up to 4x with AI-powered detail enhancement.',
                    'endpoint' => '/api/upscale.php',
                    'account' => 'user',
                    'limits' => ['free' => 3, 'premium' => 30],
                    'enabled_key' => 'tool_upscale_enabled',
                    'type' => 'upscale',
                    'section' => 'ai',
                    'badge' => 'AI',
                ],
                'erase' => [
                    ...
                    'name' => 'Magic Eraser',
                    'icon' => 'wand-2',
                    'description' => 'Paint away unwanted objects, watermarks, or people with AI inpainting.',
                    'endpoint' => '/api/erase.php',
                    'account' => 'user',
                    'limits' => ['free' => 3, 'premium' => 30],
                    'enabled_key' => 'tool_erase_enabled',
                    'type' => 'erase',
                    'section' => 'ai',
                    'badge' => 'AI',
                ],
                'faceblur' => [
                    ...
                    'name' => 'Face Blur',
                    'icon' => 'scan-face',
                    'description' => 'Automatically detect and blur faces to protect privacy in photos.',
                    'endpoint' => '/api/faceblur.php',
                    'account' => 'user',
                    'limits' => ['free' => 10, 'premium' => 100],
                    'enabled_key' => 'tool_faceblur_enabled',
                    'type' => 'faceblur',
                    'section' => 'ai',
                    'badge' => 'AI',
                ],
                'palette' => [
                    ...
                    'name' => 'Color Palette',
                    'icon' => 'palette',
                    'description' => 'Extract dominant colors and copy hex codes from any image instantly.',
                    'endpoint' => '/api/palette.php',
                    'account' => 'guest',
                    'limits' => ['guest' => 20],
                    'enabled_key' => 'tool_palette_enabled',
                    'type' => 'palette',
                    'section' => 'quick',
                    'badge' => 'Instant',
                ],
                'qr' => [
                    ...
                    'name' => 'QR Code',
                    'icon' => 'qr-code',
                    'description' => 'Generate shareable QR codes for any image URL in your browser.',
                    'endpoint' => null,
                    'account' => 'guest',
                    'limits' => null,
                    'enabled_key' => 'tool_qr_enabled',
                    'type' => 'qr',
                    'section' => 'quick',
                    'badge' => 'Instant',
                ],
